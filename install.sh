...
REPO="https://api.github.com/repos/techalodev/reNetShift/releases/latest"
...
RELEASES_LATEST_REDIRECT="https://github.com/techalodev/reNetShift/releases/latest"
RELEASES_DOWNLOAD_BASE="https://github.com/techalodev/reNetShift/releases/download"
...
update_config() {
    ...
    printf "\033[48;5;196m\033[1m║ Подробности: https://github.com/techalodev/reNetShift                  ║\033[0m\n"
    ...
    printf "\033[48;5;196m\033[1m║ Details: https://github.com/techalodev/reNetShift                      ║\033[0m\n"
    ...
    while true; do
            ...
            yes|y|Y)
                ...
                wget -O /etc/config/netshift https://raw.githubusercontent.com/techalodev/reNetShift/refs/heads/main/netshift/files/etc/config/netshift
